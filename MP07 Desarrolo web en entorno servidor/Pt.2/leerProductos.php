      ...
      <tbody>
        ...
        if($buscador != NULL ||  $buscador != ""){
          ...
          while($fila=$consulta->fetch_assoc()){
              ...
              echo "<td>".$fila["precio"]."</td>";
              echo "<td>".$fila["descripcion"]."</td>";
              echo "<td>".'<button class="fa fa-cart-plus" aria-hidden="true" style="color:black;font-size:40px;padding-right:5%" onclick="addCart($iduser,$con)" ></button>'."</td>";
              echo "</tr>";
          }
        }
        ?>
...
<?php
  ...
  function addCart($iduser,$con){
    $sqlCarro="INSERT INTO `carrito`(`id`, `idusuario`) 
    VALUES (NULL,$iduser)";
